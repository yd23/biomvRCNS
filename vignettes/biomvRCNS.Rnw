...
Here we set \Rfunarg{tofile=FALSE} to output graphics to the current device, and only show resulting graphics for chromosome 11 from sample Coriell.05296.
